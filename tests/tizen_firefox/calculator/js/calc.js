...
$(function() {
    ...
    Calculator = new function() {
        ...
        // Data
        //
        this.parser = PEG.buildParser(document.getElementById("grammar").textContent);
        ...
        this.onFunctionButtonClick = function() {
            //Calculator.buttonClickAudio.play(); // disabled by MP to avoid fcts dispatched via jQuery
        ...
        this.onNumericalButtonClick = function() {
            console.log("onNumBtnClick with currentFormula: "+Calculator.currentFormula);
        ...
        this.onEqualButtonClick = function() {
            //Calculator.equalClickAudio.play();// disabled by MP to avoid fcts dispatched via jQuery
            Calculator.handleClearOnFunctionButtonClick();
            ...
            if (formula != "") {
                try {
                    console.log("MP RAD: parse with: "+formula);
        ...
        this.initButtons = function() {
            ...
            // this.initAudio();  // disabled by MP to avoid fcts dispatched via jQuery
        };
