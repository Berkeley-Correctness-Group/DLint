...
function Todo() {
    ...
    this.__init_edit_ui_text = function(text) {
        document.title = "Edit View"; // added by MP
    ...
    this.__init_settings_ui_default_view = function(default_view_id) {
        document.title = "Settings View"; // added by MP
    ...
    this.__init_swipe_day_view  = function($self){
        document.title = "Day View"; // added by MP
    ...
    this.__init_swipe_week_view = function ($self) {
        document.title = "Week View"; // added by MP
    ...
    this.__init_notes_view = function() {
        document.title = "Notes View"; // added by MP
    ...
    this.init = function() {
        ...
        //document.title = _("Todo List"); // undefined, removed by MP
